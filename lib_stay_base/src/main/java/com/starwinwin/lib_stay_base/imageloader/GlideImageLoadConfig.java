...
public class GlideImageLoadConfig {
    ...
    private int CropType = 0; //裁剪类型,默认不做处理
    ...
    private boolean skipMemoryCache;//true,跳过内存缓存,系统默认false
    private DiskCache diskCacheStrategy; //硬盘缓存,系统默认为all类型
    ...
    private float rotateDegree;//默认旋转°
    private int cornersSize;//圆角大小
    private int blurSize;//模糊度
    ...
    private GlideImageLoadConfig(GlideImageLoadConfig.Builder builder) {
    ...
    public static class Builder {
        ...
        private float rotateDegree = 90f;//默认旋转90
        private int cornersSize;//默认0
        private int blurSize;//默认0
        private String tag;
        ...
        public Builder setRotateDegree(float rotateDegree) {
            this.rotateDegree = rotateDegree;
            return this;
        }

        public Builder setCornerSize(int cornersSize) {
    ...
    public static Builder parseBuilder(GlideImageLoadConfig config) {
